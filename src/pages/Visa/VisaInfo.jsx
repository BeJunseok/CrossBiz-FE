...
export default function VisaInfo() {
  ...
  return (
    <main className="min-h-screen w-full flex justify-center">
      <section className="w-full max-w-[393px]">
        ...
        >
          ...
          <div className="absolute top-6 right-6 flex gap-1.5">
            ...
            <button type="button" className="block p-0 m-0" onClick={openCopyModal} aria-label="복사/공유 옵션">
      ...
      {/* 복사 모달 */}
      {showCopyModal && (
        <div className="fixed inset-0 z-[9999] bg-black/40 backdrop-blur-[2px] flex items-end justify-center" role="dialog" aria-modal="true">
          <div className="w-full flex justify-center pb-[calc(env(safe-area-inset-bottom,0)+16px)]">
            <div className="w-[351px] max-w-[351px] rounded-2xl shadow-xl px-5 py-4">
              <div className="flex flex-col gap-3">
                <button type="button" className="w-full" aria-label="URL 복사"
                ...
                <button type="button" className="w-full" aria-label="닫기" onClick={closeCopyModal}>
